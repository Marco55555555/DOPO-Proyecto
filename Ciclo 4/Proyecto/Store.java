...
public abstract  class Store {
    ...
    */
    ...
    /** Marca la tienda como vacía (color rojo) 
    */
     ...
     * "magenta" ...
     */
    public void changeColorStore(String color){
    ...
    public int getTimesEmptied() {
      ...
      /**
     * Determina si el robot puede comprar en esta tienda.
     * Cada subclase redefine este método según su tipo.
     */
    ...
    /**
     * Realiza la venta (por defecto transfiere todo el profit al robot).
     * Las subclases pueden sobrescribirlo.
     */
    public void sellTo(Robot robot) {
        int amountToGive = robot.collectFromStore(profit);
        robot.addProfit(amountToGive);
        profit -= amountToGive;
        if (profit == 0){
